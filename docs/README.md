...
| [`frontend.md`](frontend.md) | Plain HTML vs a Vite frontend, how the CLI tells them apart, how a production bundle is flattened into the binary, and per-template sizes. |
